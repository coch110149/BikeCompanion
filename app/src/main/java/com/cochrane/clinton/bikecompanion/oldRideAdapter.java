...
//
////				TextView bikeNameView = (TextView) listItemView.findViewById(R.id
/// .ride_history_bike_name);
...
//				Bike bike = db.getBike(currentRide.getID());
//				if (bike != null)
//				{
//					TextView bikeName = (TextView) listItemView.findViewById(R.id.bike_name_information);
//					bikeName.setText(db.getBike(currentRide.getBikeID()).getBikeName());
//				}
//				db.close();
//
//			}
